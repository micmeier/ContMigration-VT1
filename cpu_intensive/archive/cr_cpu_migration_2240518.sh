...
sed -i "s|10.0.0.180:5000/localcpu:checkpoint|10.0.0.180:5000/$checkpoint_image_name:checkpoint|g" migr/restore_sts_cpu_singlecore.yaml
...
kubectl apply -f migr/restore_sts_cpu_singlecore.yaml
