...
sudo curl -sk -X POST "https://$nodename:10250/checkpoint/default/${podname}/${containername}" \
  --key /home/ubuntu/.kube/pki/cluster1-apiserver-kubelet-client.key \
  --cacert /home/ubuntu/.kube/pki/cluster1-ca.crt \
  --cert /home/ubuntu/.kube/pki/cluster1-apiserver-kubelet-client.crt
...
sed -i "s|10.0.0.180:5000/localcpu:checkpoint|10.0.0.180:5000/$checkpoint_image_name:checkpoint|g" yaml/restore_sts_cpu_singlecore.yaml
...
kubectl apply -f yaml/restore_sts_cpu_singlecore.yaml
