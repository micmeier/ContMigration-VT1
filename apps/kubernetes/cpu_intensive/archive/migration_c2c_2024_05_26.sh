...
newcontainer=$(buildah from docker.io/redis:latest)
...
#sudo buildah push --tls-verify=false localhost/$checkpoint_image_name:checkpoint 10.0.0.180:5000/$checkpoint_image_name:checkpoint
